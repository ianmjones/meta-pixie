...
class DataFormatTest extends \WP_UnitTestCase {
	...
	public function test_is_json_exists() {
		$this->assertTrue( method_exists( 'Meta_Pixie_Data_Format', 'is_json' ) );
	}
	...
	public function test_is_json_likes_simple_json() {
		...
		$result = Meta_Pixie_Data_Format::is_json( $input );
	...
	public function test_is_expandable_exists() {
		$this->assertTrue( method_exists( 'Meta_Pixie_Data_Format', 'is_expandable' ) );
	}
	...
	public function test_is_expandable_dislikes_simple_json() {
		$input  = '{"string": "some text", "int": 123}';
		$result = Meta_Pixie_Data_Format::is_expandable( $input );
		$this->assertFalse( $result );
	}
	...
	public function test_is_broken_serialized_exists() {
		$this->assertTrue( method_exists( 'Meta_Pixie_Data_Format', 'is_broken_serialized' ) );
	}
	...
	public function test_is_broken_serialized_with_broken_serialized() {
		...
		$result = Meta_Pixie_Data_Format::is_broken_serialized( $input );
		$this->assertTrue( $result );
	}
	...
	public function test_is_base64_exists() {
		$this->assertTrue( method_exists( 'Meta_Pixie_Data_Format', 'is_base64' ) );
	}
	...
	public function test_is_base64_likes_encoded_serialized_array() {
		...
		$result = Meta_Pixie_Data_Format::is_base64( $input );
		$this->assertTrue( $result );
	}
	...
	public function test_get_data_types_exists() {
		$this->assertTrue( method_exists( 'Meta_Pixie_Data_Format', 'get_data_types' ) );
	}
	...
	public function test_get_data_types_with_base64_encoded_serialized() {
		...
		$input  = serialize( $input );
		$input  = base64_encode( $input );
		$result = Meta_Pixie_Data_Format::get_data_types( $input );
