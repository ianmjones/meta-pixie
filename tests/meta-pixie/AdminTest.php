...
class AdminTest extends \WP_UnitTestCase {
	...
	public function test_our_screen_exists() {
		$this->assertTrue( method_exists( 'Meta_Pixie_Admin', 'our_screen' ) );
	}
	...
	public function test_our_screen_true() {
		...
		$this->assertTrue( Meta_Pixie_Admin::our_screen( $screen, 'wibble' ) );
	}
	...
	public function test_our_screen_false() {
		set_current_screen( 'wibble' );
		$screen = get_current_screen();
		$this->assertFalse( Meta_Pixie_Admin::our_screen( $screen, 'wobble' ) );
	}
}
